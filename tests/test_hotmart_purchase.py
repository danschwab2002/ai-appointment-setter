...
def test_contract_client_does_not_expose_legacy_hotmart_admission_methods() -> None:
    assert not hasattr(SupabaseClient, "admit_hotmart_purchase_approved")
    assert not hasattr(SupabaseClient, "admit_hotmart_cart_abandonment")
