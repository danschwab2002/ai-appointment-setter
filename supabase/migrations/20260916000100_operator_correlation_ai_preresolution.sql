...
begin
    ...
    select
        ...
        jsonb_build_object(
            ...
            'candidate_label', 'Persona ' || candidate_ordinal.ordinal::text,
    ...
    join lateral (
        ...
        ) as ordinal, candidate.purchase_intent_id
        from public.hotmart_purchase_intent_correlation_candidates candidate
        where candidate.webhook_event_id = claimed.source_event_id
    ) candidate_ordinal
      on candidate_ordinal.purchase_intent_id = pre.recommended_purchase_intent_id
