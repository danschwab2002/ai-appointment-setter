...
expected_service_role(signature) as (
    values
        ...
        ('public.mark_portable_payment_failure_request_started(uuid, uuid, text, bigint, timestamp with time zone)'),
        ...
        ('public.plan_commercial_ally_post_inbound_discount(text, text, integer, text, integer, bigint, bigint, bigint, bigint, text, timestamp with time zone)'),
        ('public.plan_portable_payment_failure_recovery(uuid, uuid, text, text, text, text, integer, timestamp with time zone, bigint, bigint, text, text, integer)'),
        ...
        ('public.get_chatwoot_payment_link_candidate(uuid, text, bigint, bigint, bigint, integer, timestamp with time zone)'),
        ...
        ('public.claim_daily_feedback_notification_v1(uuid, text, text, text, text, timestamp with time zone, integer)'),
        ('public.mark_daily_feedback_notification_started_v1(uuid, text, text, uuid, bigint)'),
        ('public.complete_daily_feedback_notification_v1(uuid, text, text, uuid, bigint)'),
        ('public.retry_daily_feedback_notification_v1(uuid, text, text, uuid, bigint, text, integer)'),
        ('public.begin_daily_feedback_oidc_v1(text, uuid, text, timestamp with time zone)'),
